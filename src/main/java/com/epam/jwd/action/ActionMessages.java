...
public class ActionMessages {
    ...
    public static final String CALCULATING_SPHERE_AREA_MESSAGE = "Calculating sphere area";
    public static final String CALCULATING_SPHERE_VOLUME_MESSAGE = "Calculating sphere volume";
